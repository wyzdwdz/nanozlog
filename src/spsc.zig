...
pub fn deinit(self: SpscVarQueue) void {
    self._allocator.free(self._blk);
}

pub fn alloc(self: *SpscVarQueue, size: u32) ?*MsgHeader {
    var asize = size;
...
pub fn front(self: *SpscVarQueue) ?*MsgHeader {
...
pub fn pop(self: *SpscVarQueue) void {
